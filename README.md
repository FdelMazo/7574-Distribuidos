...
utilizados recurrentemente en el proyecto en forma de targets.

El comando principal a utilizar es **docker-compose-up** el cual permite inicializar
...
3. Servidor procede a recibir una nueva conexión nuevamente

Al ejecutar el comando **make docker-compose-up** para comenzar la ejecución del ejemplo y luego
el comando **make docker-compose-logs**, se deberán observar los siguientes logs:
...
aplicaciones sea leída tanto por variables de ambiente como por archivo de configuración.
Configuración a través de archivo debe ser _injectada_ al ejemplo y persistida afuera
